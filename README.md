...
> This project is a platform designed to effectively present my skills, projects and experiences as a web developer. Through this page, I seek to create a digital showcase that showcases not only my previous works, but also my approach and passion for web development.
...
Feel free to check the [issues page](https://github.com/Standup13/Personal_Portfolio_Webpage/issues).
